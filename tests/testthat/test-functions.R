...
test_that("Export functions are ok", {
  ...
  expect_no_error(pt_export(obj_nums_odd, obj_nums_even, file = "outputfile", SDCtool = "TauArgus"))
  expect_no_error(pt_export(obj_nums_odd, obj_nums_even, file = "outputfile", SDCtool = "SAS"))
